...
export class FlowFactory__createChildTypedInputConfig_Struct extends ethereum.Tuple {
  get stateConfig(): FlowFactory__createChildTypedInputConfig_StateConfigStruct {
    return changetype<
      FlowFactory__createChildTypedInputConfig_StateConfigStruct
    >(this[0].toTuple());
  }

  get flowConfig(): FlowFactory__createChildTypedInputConfig_FlowConfigStruct {
    return changetype<
      FlowFactory__createChildTypedInputConfig_FlowConfigStruct
    >(this[1].toTuple());
  }
}

export class FlowFactory__createChildTypedInputConfig_StateConfigStruct extends ethereum.Tuple {
...
export class FlowFactory__createChildTypedInputConfig_FlowConfigStruct extends ethereum.Tuple {
  ...
  get flows(): Array<
    FlowFactory__createChildTypedInputConfig_FlowConfigFlowsStruct
  > {
...
export class FlowFactory__createChildTypedInputConfig_FlowConfigFlowsStruct extends ethereum.Tuple {
  get sources(): Array<Bytes> {
    return this[0].toBytesArray();
  }
...
export class FlowFactory extends ethereum.SmartContract {
  static bind(address: Address): FlowFactory {
    return new FlowFactory("FlowFactory", address);
  }
  ...
  createChildTyped(
    config_: FlowFactory__createChildTypedInputConfig_Struct
  ): Address {
    let result = super.call(
      "createChildTyped",
      "createChildTyped(((bytes[],uint256[]),(address,address,(bytes[],uint256[])[]))):(address)",
...
export class CreateChildTypedCallConfig_Struct extends ethereum.Tuple {
  get stateConfig(): CreateChildTypedCallConfig_StateConfigStruct {
    return changetype<CreateChildTypedCallConfig_StateConfigStruct>(
      this[0].toTuple()
    );
  }

  get flowConfig(): CreateChildTypedCallConfig_FlowConfigStruct {
    return changetype<CreateChildTypedCallConfig_FlowConfigStruct>(
      this[1].toTuple()
    );
  }
}

export class CreateChildTypedCallConfig_StateConfigStruct extends ethereum.Tuple {
  get sources(): Array<Bytes> {
    return this[0].toBytesArray();
  }
...
export class CreateChildTypedCallConfig_FlowConfigStruct extends ethereum.Tuple {
  get expressionDeployer(): Address {
    return this[0].toAddress();
  }
  ...
  get flows(): Array<CreateChildTypedCallConfig_FlowConfigFlowsStruct> {
    return this[2].toTupleArray<
      CreateChildTypedCallConfig_FlowConfigFlowsStruct
    >();
  }
}

export class CreateChildTypedCallConfig_FlowConfigFlowsStruct extends ethereum.Tuple {
  get sources(): Array<Bytes> {
    return this[0].toBytesArray();
  }
